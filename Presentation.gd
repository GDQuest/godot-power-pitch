...
export(String, 'en', 'ja', 'fr', 'es', 'pt_BR', 'de', 'it', 'zh', 'uk_UA', 'ko', 'sk', 'pl') var LANGUAGE_MAIN = 'en'
export(String, 'en', 'ja', 'fr', 'es', 'pt_BR', 'de', 'it', 'zh', 'uk_UA', 'ko', 'sk', 'pl') var LANGUAGE_SECOND = 'ja'
