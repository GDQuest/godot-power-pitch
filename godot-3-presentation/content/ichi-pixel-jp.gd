...
var intro = [
	...
	},
	{
		...
		"body":
			"""
			別々の[color=%s]２D[/color]と[color=%s]３D[/color]レンダリングエンジン
			機能が多い[color=%s]ゲームエディタ[/color]

			マルチプラットフォーム: Windows, Mac, Linuxでゲームを作れます
			ビルド：PC, モバイル, HTML5*""" % [BLUE, PINK, ORANGE],
		'picture': 'advanced-materials.jpg',
		"footer": "*PS4, XboxOne, Switch, PS Vita...も可能です"
	},
	{
